...
const TeachersPage = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (editItem) {
      updateMut.mutate(
        ...
        {
          onSuccess: () => {
            toast.success(t("teachers.toast_updated"));
            setModalOpen(false);
          },
      ...
      createMut.mutate(payload, {
        onSuccess: () => {
          toast.success(t("teachers.toast_created"));
          setModalOpen(false);
        },
        onError: () => toast.error(t("teachers.toast_error")),
      });
  ...
  const handleDelete = () => {
    ...
    deleteMut.mutate(deleteId, {
      onSuccess: () => {
        toast.success(t("teachers.toast_deleted"));
        setDeleteId(null);
      },
      onError: () => toast.error(t("teachers.toast_error")),
    });
    ...
    <div className="space-y-6">
      <div className="flex flex-wrap items-center justify-between gap-4">
        ...
        <Button className="gap-2" onClick={openCreate}>
          <Plus className="h-4 w-4" /> {t("teachers.add_new")}
        </Button>
      </div>
        ...
        <DialogContent className="max-w-md bg-card border-border">
          <DialogHeader>
            <DialogTitle className="font-heading">
              {editItem ? t("teachers.edit_title") : t("teachers.add_title")}
            </DialogTitle>
          </DialogHeader>
